...
Există posibilitatea ca diferite persoane / ramuri Lacanu din Vulturu, Smeeni sau localități apropiate să fie legate genealogic. Această posibilitate nu este tratată ca fapt până la apariția unor documente directe sau a unui lanț de dovezi suficient.
...
| `Stoica` nu se echivalează cu `St.` | Act de căsătorie Vulturu 1908 + regulă metodologică | Nu știm dacă `St.` este abreviere pentru Stan, Stancu, Stanciu, Stoica sau altceva |
| Nu știm dacă `Stoica` este prenume, patronim, poreclă sau nume de ramură | Act de căsătorie Vulturu 1908 | Se păstrează ca element nominal neclasificat |
