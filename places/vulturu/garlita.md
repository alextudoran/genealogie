# Gârlița — context local Vulturu

## Status

Notă de context local. Necesită verificare documentară.

## Descriere din memorie
...
Casa asociată lui Mănăilă M. Lăcanu era în zona Gârliței. În memoria recentă era cunoscută ca o casă foarte modestă, cu două camere și o marchiză. A rezistat până de curând.

Trei dintre frații vitregi ai bunicului cercetătorului — Constantin, Petrea și Mihai — au rămas în această casă. Dintre aceștia, doar Mihai s-a căsătorit și a avut copii.

Bunicul cercetătorului a avut casa tot în această zonă, dar terenul provenea din familia bunicii.

## Graniță, drum și repere istorice
...
## Elemente importante de cercetat

- Identificarea exactă a Gârliței pe hărți istorice.
...
- Poziția casei lui Mănăilă față de aceste repere.

## Relevanță genealogică

Zona poate ajuta la corelarea:

- gospodăriilor;
- proprietăților;
- vecinilor;
- hotarelor;
- familiilor aflate la marginea satului;
- documentelor care folosesc repere locale, nu adrese moderne.

## Surse

- Memorie familială discutată în cercetare, 2026-06.

## Nivel de încredere

Memorie orală / familială. Necesită confirmare prin hărți, registre, acte de proprietate sau documente administrative.
